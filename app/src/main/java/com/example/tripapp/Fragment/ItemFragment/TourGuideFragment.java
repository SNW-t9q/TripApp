package com.example.tripapp.Fragment.ItemFragment;
...
public class TourGuideFragment extends Fragment {
    ...
    public static TourGuideFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView guide = view.findViewById(R.id.tv_guide);
